...
(function() {
    ...
    statusDiv.textContent = "AutoE:OFF[Speedx]";  // 預設為OFF(沒觸發時為OFF)
    ...
    eCounterDiv.style.color = 'purple';
    ...
    document.addEventListener("mouseup", function(event) {
        if (event.button === 2) {  // 右鍵(通稱Button 2)
            ...
            stopAutoE();  // 停止連點AutoE
            statusDiv.style.color = 'purple'; //未觸發顏色：紅色
            statusDiv.textContent = "AutoE:OFF[Speedx]";  // 顯示狀態為AutoE:OFF[Speedx1]"
        }
    });
