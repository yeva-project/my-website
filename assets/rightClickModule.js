...
(function() {
    ...
    (function () {
        ...
        window.autoEKey = "RightMouseButton"; // Изменено на правую кнопку мыши
        ...
        document.addEventListener('mousedown', (e) => {
            if (e.button === 2 && !isRunning) { // e.button === 2 для правой кнопки мыши
                zetaXProcessor();
            }
        });

        document.addEventListener('mouseup', (e) => {
            if (e.button === 2) { // e.button === 2 для правой кнопки мыши
                stopZetaXProcessor();
            }
        });
